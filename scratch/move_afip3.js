...
if (fiscalStartIdx !== -1 && nextViewStartIdx !== -1) {
    ...
    while(endInner > fiscalStartIdx && !lines[endInner].includes(")}")) {
        endInner--;
    }
    
    // slice(fiscalStartIdx + 1, endInner) will include <div ...> up to </div>
    const fiscalContentLines = lines.slice(fiscalStartIdx + 1, endInner);
